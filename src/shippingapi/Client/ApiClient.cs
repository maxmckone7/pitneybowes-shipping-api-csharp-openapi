...
namespace shippingapi.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = shippingapi.Client.Configuration.Default;
            RestClient = new RestClient("https://api-sandbox.pitneybowes.com/shippingservices");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api-sandbox.pitneybowes.com/shippingservices).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? shippingapi.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://api-sandbox.pitneybowes.com/shippingservices")
        {
            ...
            String contentType)
        {
            ...
            headerParams.Add("User-Agent", "PitneyBowes-CSharpSDKOpenAPI 1.6.1");
